<template>
	<view class="container">
		<u-navbar bgColor="#f3f4f5" height="54" title="提交订单" :autoBack="true">
		</u-navbar>
		<view class="box">
			<view class="list">
			...
			<view class="payment">
				...
				<u-radio-group v-model="radiovalue1" placement="column" @change="payChange">
					<view class="kinds">
						<view class="item">
							<view class="payName">
								<image src="@/static/pay/weChat.png">
								</image>
								<text>
									微信支付
								</text>
							...
							<view class="select">
								<u-radio activeColor="#48C368" name="微信支付">
								</u-radio>
							</view>
						</view>
						<view class="item">
							<view class="payName">
								<image src="@/static/pay/aliPay.png">
								</image>
								<text>
									支付宝支付
								</text>
							...
							<view class="select">
								<u-radio activeColor="#48C368" name="支付宝支付">
								</u-radio>
							</view>
						</view>
					</view>
						...
						.right {
							...
							&>.price {
								text {
									...
									&:first-child {
										@include fontStyle(22rpx, 600, #999999, 50rpx);
										color: #999999;
									...
									&:last-child {
										@include fontStyle(36rpx, 400, #333333, 32rpx);
										color: #333333;
